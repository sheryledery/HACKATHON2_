...
canvas = main.Canvas(main, height=HEIGHT, width=WIDTH)
canvas.pack()

frame = main.Frame(main, bg ='#2E9CB3', bd=5)
frame.place(relx=0.5, rely= 0.1, relwidth= 0.75, relheight= 0.1, anchor='n')
entry = main.Entry(frame, font= 50 )
entry.place(relwidth=0.65, relheight=1)
button = main.Button(frame, text='Find Forecast', font= 60, command= lambda: get_weather(entry.get()))
button.place(relx=0.7, relheight=1, relwidth=0.3)
lower_frame = main.Frame(main, bg='#2E9CB3', bd=10)
lower_frame.place(relx=0.5, rely= 0.25, relwidth= 0.75, relheight= 0.6, anchor='n')
label = main.Label(lower_frame)
